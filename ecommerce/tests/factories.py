...
class ProductFactory(factory.django.DjangoModelFactory):
    ...
    web_id = factory.Sequence(lambda n: "web_id_{}".format(n))
...
class BrandFactory(factory.django.DjangoModelFactory):
    ...
    name = factory.Sequence(lambda n: "brand_{}".format(n))
...
class ProductInventoryFactory(factory.django.DjangoModelFactory):
    ...
    sku = factory.Sequence(lambda n: "sku_{}".format(n))
    upc = factory.Sequence(lambda n: "upc_{}".format(n))
